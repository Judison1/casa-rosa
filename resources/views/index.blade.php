<x-layouts.public-layout>
    <section class="jumbotron w-full">
        <div class="px-4 py-8 flex flex-col xl:flex-row items-center justify-center max-w-7xl mx-auto gap-4 h-[60vh]">
            <div class="grow w-full xl:w-2/3">
                <h2 class="text-2xl xl:text-7xl font-bold text-rose-200">A Nossa Luta é Todo Dia</h2>
    ...
    <section id="parceiros" class="bg-white h-[30vh]">
        <div class="w-full flex items-center justify-between max-w-7xl mx-auto flex-col gap-4 px-4 py-8">
            <h3 class="text-center text-xl font-semibold text-rose-500">Parceiros</h3>
    ...
    <section id="seja-doador" class="bg-rose-500">
        <div class="w-full flex items-center justify-between max-w-7xl mx-auto flex-col gap-4 px-4 py-8">
            <h3 class="text-center text-xl font-semibold text-white">Seja um doador</h3>
    ...
    <section id="seja-voluntario" class="bg-white ">
        <div class="w-full flex items-center justify-between max-w-7xl mx-auto flex-col gap-4 px-4 py-8">
            <h3 class="text-center text-xl font-semibold text-rose-500">Seja um voluntário</h3>
            <div class="p-4 flex w-full flex-col xl:flex-row items-center justify-center max-w-7xl mx-auto gap-4 h-[60vh]">
    ...
    <section id="fale-conosco" class=" bg-rose-500">
        <div class="w-full flex items-center justify-between max-w-7xl mx-auto flex-col gap-4 px-4 py-8">
            <h3 class="text-center text-xl font-semibold text-white">Fale Conosco</h3>
            <div class="grid grid-cols-1 w-full xl:grid-cols-2 gap-8 p-4 items-center justify-center">
                <div class="text-white">
                    <iframe
                        ...
                        width="100%" height="500" style="border:0;" class="mb-4 rounded-lg" allowfullscreen=""
