...
<div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="space-y-8">
            <img class="h-20" src="{{ asset('img/logo.png') }}" alt="Company name">
            <p class="text-sm leading-6 text-gray-600">A Nossa Luta é Todo Dia. Casa de Apoio a Mulher com Câncer -
                Santarém - PA</p>
    ...
    <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
        <p class="text-xs leading-5 text-gray-500">&copy; {{ date('Y') }} Desenvolvido por NTI.</p>
    </div>
</div>
